...
def page_about():
    ...
    st.image(r".\image\satu.jpg", caption="Jumlah Dokumen Barang Kiriman", use_column_width=True)
    st.image(r".\image\dua.jpg", caption="Facts", use_column_width=True)
...
def main():
    st.image(r".\image\belanja3.jpg", use_column_width=True)
